...
class MacOSNativeDanmaku<T> extends StatefulWidget {
  const MacOSNativeDanmaku({
    super.key,
  ...
  @override
  State<MacOSNativeDanmaku<T>> createState() => _MacOSNativeDanmakuState<T>();
}

class _MacOSNativeDanmakuState<T> extends State<MacOSNativeDanmaku<T>> {
  static const _useFlutterRaster = bool.fromEnvironment(
    'PILIPLUS_MACOS_FLUTTER_RASTER_DANMAKU',
  );
  ...
  @override
  void didUpdateWidget(covariant MacOSNativeDanmaku<T> oldWidget) {
