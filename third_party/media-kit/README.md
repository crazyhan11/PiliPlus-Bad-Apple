...
> This vendored copy packages an iOS arm64 libmpv/FFmpeg build with
> `av1_videotoolbox` enabled for PiliPlus. The bundled archive is selected by
> `libs/ios/media_kit_libs_ios_video/ios/Makefile`; all other platform behavior
> remains based on the upstream `version_1.2.5` branch.
>
> Archive SHA-256:
> `21067a1f98e68bb7172d6543b5ac0f1e95f22a10891a8a073cff089a29fabd17`.
> The source patch and rebuild script are maintained in the parent
> PiliPlus-AV1 repository under `tool/`.
